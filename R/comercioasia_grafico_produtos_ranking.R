...
#'
#' @export
comercioasia_grafico_produtos_ranking <- function(pais, periodo) {
  ...
  if (periodo == "mensal") {
    ...
    frase <- paste0("agregado at\u00e9 ", Asia::meses(Asia::comercioasia_get_ultimomes()))
    ...
    frase <- paste0("at\u00e9 ", Asia::comercioasia_get_ulimoano())
  ...
  df %>%
    ...
    ggplot2::labs(title = glue::glue("Asia, evolu\u00e7\u00e3o do com\u00e9rcio, {frase}"),
